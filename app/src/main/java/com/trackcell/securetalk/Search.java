...
public class Search extends Activity
{
                ...
                try
                {
                    ...
                    for (int i = 0; i < mItems.getJSONArray("item").length(); i++)
                    {
                        ...
                        if(!mPrefsGlobal.getString("owner", "none").equals(currentObject.getString("id")))
                            mContactList.add(new EnumContact(getApplicationContext(), currentObject.getString("id"), currentObject.getString("name"), currentObject.getString("description"), currentObject.getString("public_key"), false).hideArrow().bwPhoto());
    ...
    public void test()
    {
        ...
        while (phones.moveToNext())
        {
            ...
            mContactList.add(new EnumContact(getApplicationContext(), "785b86f1ea73414d6c0493b2411421ba", name, IPN, "none", false).hidePhoto().hideArrow());
        }
        phones.close();
