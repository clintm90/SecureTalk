 ...
 * {@link Invite.OnFragmentInteractionListener} interface
...
public class Invite extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        /*ListView mInviteList = (ListView)rootView.findViewById(R.id.fragment_invite_list);

        List<EnumContact> CONTACTLIST = new ArrayList<EnumContact>();

        final ContactListAdapter mContactListAdapter = new ContactListAdapter(getActivity().getApplicationContext(), CONTACTLIST);

        mContactListAdapter.add(new EnumContact(getActivity().getApplicationContext(), 0, "salut", "ds", "slaut", "s", false));

        mInviteList.setAdapter(mContactListAdapter);*/
